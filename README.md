...
Я — тестировщик программного обеспечения. Завершил курс «Инженер по тестированию» в Яндекс Практикуме, а также два специализированных курса на Stepik, что позволило существенно расширить мои профессиональные навыки.

Работаю в сфере тестирования: имею опыт в проверке мобильных и веб-приложений, пишу тест-кейсы и баг-репорты, провожу ручное и API-тестирование. Умею анализировать и документировать результаты тестов, разрабатывать стратегии тестирования и составлять тест-планы.

Я увлечён тестированием и стремлюсь постоянно развиваться в этой области, находя новые задачи для повышения качества программного обеспечения.
...
<a href="https://developer.android.com" target="_blank">
    <img src="https://img.shields.io/static/v1?message=Android%20Studio&logo=android&label=&color=000000&logoColor=&labelColor=&style=for-the-badge" height="30" alt="Android Studio logo" />
</a>
